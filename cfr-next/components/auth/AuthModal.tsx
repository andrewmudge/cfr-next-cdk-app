          ...
          <div className="p-6 pt-0">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button
                ...
                className="gsi-material-button w-full flex items-center justify-center relative overflow-hidden border border-[#747775] rounded-md bg-white h-10 px-3 focus:outline-none transition duration-200 disabled:cursor-default disabled:bg-[#ffffff61] disabled:border-[#1f1f1f1f]"
                style={{ fontFamily: 'Roboto, Arial, sans-serif', fontSize: 14, letterSpacing: '0.25px', maxWidth: 400, minWidth: 'min-content' }}
              >
                <div className="gsi-material-button-state absolute inset-0 opacity-0 transition-opacity duration-200 pointer-events-none" />
                <div className="gsi-material-button-content-wrapper flex items-center w-full h-full relative">
                  <div className="gsi-material-button-icon w-5 h-5 min-w-[20px] mr-3">
                  ...
                  <span className="gsi-material-button-contents font-medium overflow-hidden text-ellipsis">Sign in with Google</span>
